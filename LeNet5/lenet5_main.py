...
csv_file_path = 'LeNet5_summary.csv'
...
optimizer = th.optim.AdamW(model.parameters(), lr=0.01, weight_decay=5e-4)
...
while continue_pruning:
    ...
    for epoch in range(epochs):
        ...
        #writer.add_scalar('Loss/Train', running_loss / len(trainloader), epoch)
        #writer.add_scalar('Accuracy/Train', epoch_train_acc, epoch)
        #writer.add_scalar('Finetuning Term', finetuning_term, epoch)
